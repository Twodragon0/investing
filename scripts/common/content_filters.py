...
_DEFAULT_ENTERTAINMENT_KEYWORDS: frozenset = frozenset({
    ...
    "championship", "championships", "playoffs", "playoff", "mvp", "ballon d'or",
    "nfl draft", "nba draft", "mlb playoffs",
    "masters tournament", "us open tennis", "french open", "australian open",
    # 스포츠 행위/기록
    "touchdown", "home run", "slam dunk", "penalty kick", "hat trick",
    "mvp award", "draft pick",
    "trade deadline nba", "trade deadline nhl", "trade deadline nfl",
    "free agency nba", "free agency nfl",
    "signing bonus nfl", "signing bonus nba",
    # NBA 팀명
    ...
    # MLB/NFL 팀명
    "yankees", "dodgers", "patriots", "cowboys",
    # 시상식 / 연예 행사
    "oscar", "grammy", "emmy", "golden globe", "bafta", "cannes",
    "bachelor", "bachelorette", "survivor",
    # 미디어 / 팝컬처
    "netflix", "spotify", "disney+", "hulu", "hbo",
    "movie", "album", "box office", "billboard", "celebrity",
    "reality tv", "tv show", "season finale",
    "movie release", "album release", "billboard chart",
    "netflix show", "celebrity gossip", "celebrity drama",
    "taylor swift concert", "met gala",
    # 게임 (crypto-gaming 맥락 아닌 순수 게임 출시/이슈)
    "gta vi", "gta 6", "gta v", "esport", "e-sport",
    "video game", "game release",
    # 기타
    "grand prix winner", "champions league final", "championship game",
})
