...
class TestCryptoNewsCollectorIntegration:
    ...
    def test_fetch_uses_binance_api_fallback_when_browser_announcements_missing(self):
        ...
        with (
            ...
            patch("collect_crypto_news.fetch_google_news_crypto", return_value=google_rss_items),
    ...
    def test_run_creates_only_security_post_when_market_sources_are_empty(self):
        ...
        with (
            ...
            patch("collect_crypto_news.fetch_google_news_crypto", return_value=[]),
...
class TestMarketIndicatorsCollectorIntegration:
    ...
    def test_run_creates_market_indicators_post_with_signal_tracking_and_briefing_image(self):
        ...
        with (
            ...
            patch("collect_market_indicators.fetch_treasury_yield_news", return_value=treasury_news),
            patch("collect_market_indicators.fetch_put_call_ratio_news", return_value=put_call_news),
            patch("collect_market_indicators.fetch_market_breadth_news", return_value=breadth_news),
            patch("collect_market_indicators.fetch_margin_debt_news", return_value=margin_news),
