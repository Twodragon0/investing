...
<strong>소셜 미디어 **매크로/금리, 정치/정책** 관련 34건 포착</strong><ul><li>📊 <strong>매크로/금리</strong> (11건): JAMES LAVISH: 연준의 통화 공급 및 자본 접근성 조작이 칸티용 효과를 완전히 야기했습니다.</li><li>🏛️ <strong>정치/정책</strong> (7건): 트럼프 대통령이 "암호화폐를 활용해 미국의 $35조 부채를 상환할 수 있을 것"이라고 제안했습니다.</li><li>🟠 <strong>비트코인</strong> (4건): 바이낸스가 SAFU 펀드를 위해 $3.05억 규모의 비트코인 4,545개를 추가 매입했습니다.</li><li>🏦 <strong>거래소</strong> (6건): 바이낸스가 SAFU 펀드를 위해 $3.05억 규모의 비트코인 4,545개를 추가 매입했습니다.</li></ul></div>
...
<picture><source srcset="{{ '/assets/images/generated/source-distribution-2026-02-17.webp' | relative_url }}" type="image/webp"><img src="{{ '/assets/images/generated/source-distribution-2026-02-17.png' | relative_url }}" alt="source-distribution" loading="lazy" decoding="async"></picture>


## 전체 뉴스 요약

오늘 수집된 총 34건 중 텔레그램 20건, 소셜 0건, 정치·경제 14건으로 매크로/금리 및 정치/정책 이슈가 주요 화제입니다.
...
바이낸스가 SAFU 펀드를 위해 $3.05억 규모의 비트코인 4,545개를 추가 매입했습니다.
<span class=”source-tag”>Telegram @crypto</span>
...
**4. [감사원 정책감사 폐지한다는데이재명 정부에선 ‘정치적 감사’ 사라질까 ](https://news.google.com/rss/articles/CBMiT0FVX3lxTE1jd1FPUnNqa1A3WnlBeGMyQk5ObHFfRWJadUkza01BeFhJLUpOU1MxYVlDY2c1ek05TXl5VkkxOVQ0OUloX0o4cWpReUhZc1k?oc=5)**
