...
- [Gemini Stock Dives as Winklevoss-Led Crypto Exchange Dumps Executives](https://decrypt.co/358325/gemini-stock-dives-winklevoss-crypto-exchange-dumps-executives) — 거래소 — Gemini Stock Dives as Winklevoss-Led Crypto Exchange Dumps.
- [Kraken integrates with ICE Chat to expand institutional OTC access](https://cointelegraph.com/news/kraken-integrates-with-ice-chat-to-expand-institutional-otc-access?utm_source=rss_feed&utm_medium=rss&utm_campaign=rss_partner_inbound) — 거래소 — Kraken integrates with ICE Chat to expand institutional OTC.
...
- [Stripe-Owned Bridge Gains National Bank Trust Charter to Boost Stablecoin Offerings](https://decrypt.co/358355/stripe-owned-bridge-national-bank-trust-charter-stablecoin-offerings) — 시장 상승 — Stripe-Owned Bridge Gains National Bank Trust Charter.
- [Tom Lee Expects 'Defining Year for Ethereum' as BitMine Buys ETH Amid 'Rock Bottom' Vibes](https://decrypt.co/358322/tom-lee-defining-year-ethereum-bitmine-buys-eth-rock-bottom-vibes) — 이더리움 — Tom Lee Expects 'Defining Year for Ethereum' as Bit.
- [ZeroLend Latest DeFi Platform to Shut Down Amid Liquidity, Revenue Pressures](https://decrypt.co/358304/zerolend-latest-defi-platform-to-shut-down-amid-liquidity-revenue-pressures) — Zero.
- [Ether bulls target $2.5K as staking ETF launch, RWA market cap reflect growth](https://cointelegraph.com/news/ether-bulls-target-2-5k-as-staking-etf-launch-rwa-market-cap-reflect-growth?utm_source=rss_feed&utm_medium=rss&utm_campaign=rss_partner_inbound) — 이더리움 발표 — Ether bulls target $2.5K as staking ETF launch, RWA market.
- [Stripe-owned Bridge gets OCC conditional approval for national bank charter](https://cointelegraph.com/news/bridge-stripe-occ-approval-national-trust-bank?utm_source=rss_feed&utm_medium=rss&utm_campaign=rss_partner_inbound) — 신규 발표 — Stripe-owned Bridge gets OCC conditional approval.
