...
description: "오늘의 주식 시장: 주식 시장 뉴스 종합 - 2026-02-20. 주요 지수와 종목 흐름을 정리합니다. 주요 키워드: stock, market, daily-digest."
...
permalink: "/stock-news/2026/02/20/daily-stock-news-digest/"
---
...
- S&P 500(-0.28%), 다우(-0.54%), 나스닥(-0.31%) 모두 하락 마감했습니다. 미국-이란 긴장 고조로 유가가 6개월 최고치까지 급등하면서 리스크 자산에 압박을 가했습니다. 유틸리티와 에너지 섹터만 상승한 반면, Nvidia 하락과 사모펀드주 급락이 시장을…
...
|----------|------|--------|
| **KOSPI** | 5,747.60 | 🟢 +1.24% |
| **KOSDAQ** | 1,157.98 | 🔴 -0.46% |
| **USD/KRW** | 1,448.99 | 🔴 -0.03% |
...
S&P 500(-0.28%), 다우(-0.54%), 나스닥(-0.31%) 모두 하락 마감했습니다. **미국-이란 긴장** 고조로 유가가 6개월 최고치까지 급등하면서 리스크 자산에 압박을 가했습니다. 유틸리티와 에너지 섹터만 상승한 반면, Nvidia 하락과 사모펀드주 급락이 시장을 끌어내렸습니다.

**주요 포인트:**
- **다우존스 사상 최고치 기록** 후 반락. 3일 연속 상승세 중단.
- **Walmart 실적 전망 부진**: 가이던스 하향으로 소비 심리 우려.
- **Treasury 금리 상승**: Fed 의사록에서 금리 인하에 대한 의견 분열 확인.
- **S&P 500 역사적 구조 변화**: 시가총액 집중도 심화 논의.

### 한국

KOSPI **5,747.60(+1.24%)** 강세 마감. '윤석열 무기징역' 선고일에 코스피·코스닥이 동반 상승했으며, 반도체 섹터가 상승을 주도했습니다. KOSDAQ은 -0.46%로 소폭 조정.

**주요 포인트:**
- **반도체 ETF 5조 뭉칫돈 유입**: 삼성전자·SK하이닉스 랠리 지속.
- **이재명 정책 기대감**: 외국인이 코스닥 관련 ETF를 '폭풍 매수'.
- **코넥스 외면**: 코스피·코스닥 불장에도 코넥스는 투자자 관심 밖.
- **"내달까지 반도체 주도 상승장" 전망** 확산.
...
| 섹터 | 방향 | 요약 |
|------|:---:|------|
| AI/기술 | 🔴 | Nvidia 하락, AI 우려 일시 후퇴 후 재부각 |
| 에너지 | 🟢 | 이란-미국 긴장으로 유가 급등, 에너지주 강세 |
| 유틸리티 | 🟢 | 방어적 섹터로 자금 유입, S&P 500 내 유일한 강세 |
| 금융 | 🔴 | 사모펀드주 급락, 금리 불확실성 |
| 반도체 | 🟢 | 한국 반도체 ETF 강세, 글로벌 AI 칩 수요 지속 |

---

## 인사이트

> **미국**: 이란 긴장 + Fed 매파 → 단기 변동성 확대 예상. 유가 상승이 인플레이션 우려를 재점화할 가능성.
> **한국**: 반도체 주도 상승 지속 전망이나, 환율(1,449원)과 KOSDAQ 조정은 모니터링 필요.
> **주목 이벤트**: 경제 지표 발표, 관세 법원 판결 가능성.

> *본 시장 리포트는 자동 수집된 데이터를 기반으로 생성되었으며, 투자 조언이 아닙니다.*
