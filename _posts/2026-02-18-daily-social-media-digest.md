...
<strong>소셜 미디어 **정치/정책, 매크로/금리** 관련 36건 포착</strong><ul><li>🏛️ <strong>정치/정책</strong> (8건): 트럼프 대통령이 “암호화폐를 활용해 미국의 $35조 부채를 상환할 수 있을 것”이라고 제안했습니다.</li><li>📊 <strong>매크로/금리</strong> (9건): JAMES LAVISH: “연준의 통화 공급 및 자본 접근성 조작이 칸티용 효과를 완전히 야기했다”</li><li>🟠 <strong>비트코인</strong> (4건): Polymarket이 “상승 또는 하락” 비트코인 예측 시장을 출시했습니다.</li><li>🏦 <strong>거래소</strong> (6건): 최근 온체인 예치 데이터에 따르면 고래들이 지난 4일간 거래소에 약 57,000 BTC를 전송했습니다.</li></ul></div>
...
<picture><source srcset="{{ '/assets/images/generated/source-distribution-2026-02-18.webp' | relative_url }}" type="image/webp"><img src="{{ '/assets/images/generated/source-distribution-2026-02-18.png' | relative_url }}" alt="source-distribution" loading="lazy" decoding="async"></picture>


## 전체 뉴스 요약

오늘 수집된 총 36건 중 텔레그램 20건, 소셜 0건, 정치·경제 16건으로 정치/정책 및 매크로/금리 이슈가 주요 화제입니다.
...
Polymarket이 “상승 또는 하락” 비트코인 예측 시장을 출시했습니다. 새로운 BTC 예측 마켓이 Chainlink의 BTC/USD 가격 피드를 통해 정산되며 서비스를 시작했습니다.
