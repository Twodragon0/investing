...
- 블록체인 업계 뉴스 브리핑: 최신 개발, 규제 동향, 시장 소식을 전해드립니다.
- 1. "전략비축은 쌀 때 사는 것"…트럼프는 왜 비트코인을 안 사나? (BlockMedia) 2. 빗썸, 비트코인 오지급…금융당국 긴급점검(종합) (BlockMedia) 3. NBC 진행자 서배너 거스리 모친 실종⋯비트코인 몸값 의혹 확산 (BlockMedia) 4. [AAS 위클...


## 국내 블록체인 뉴스

1. **"전략비축은 쌀 때 사는 것"…트럼프는 왜 비트코인을 안 사나?** (BlockMedia)
2. **빗썸, 비트코인 오지급…금융당국 긴급점검(종합)** (BlockMedia)
