...
<strong>소셜 미디어 **매크로/금리, 비트코인** 관련 29건 포착</strong><ul><li>📊 <strong>매크로/금리</strong> (9건): 💵 💵 💵 💵 💵 💵 60,000,000 #USDT (59,732,218 USD) minted at Tether TreasuryTx: https://t.co/mMr3UVbbjE</li><li>🟠 <strong>비트코인</strong> (4건): Kalshi 트레이더들은 비트코인이 올해 $48,000까지 급락할 수 있다고 베팅하고 있습니다.</li><li>🏦 <strong>거래소</strong> (6건): 바이낸스가 SAFU 펀드를 위해 $3.05억 규모의 비트코인 4,545개를 추가 매입했습니다.</li><li>🏛️ <strong>정치/정책</strong> (3건): 트럼프 대통령이 "암호화폐를 활용해 미국의 $35조 부채를 상환할 수 있을 것"이라고 제안했습니다.</li></ul></div>
...
<picture><source srcset="{{ '/assets/images/generated/source-distribution-2026-02-16.webp' | relative_url }}" type="image/webp"><img src="{{ '/assets/images/generated/source-distribution-2026-02-16.png' | relative_url }}" alt="source-distribution" loading="lazy" decoding="async"></picture>


## 전체 뉴스 요약

오늘 수집된 총 29건 중 텔레그램 20건, 소셜 0건, 정치·경제 9건으로 매크로/금리 및 비트코인 이슈가 주요 화제입니다.
...
Kalshi 트레이더들은 비트코인이 올해 $48,000까지 급락할 수 있다고 베팅하고 있습니다.
<span class=”source-tag”>Telegram @crypto</span>
