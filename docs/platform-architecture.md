...
│  │  "시장을 읽는다"              │───▶│  "시장에서 행동한다"              │   │
│  │                              │    │                                  │   │
│  │  - 뉴스/규제/정치 수집        │    │  - 14-Component 시그널 합성      │   │
│  │  - 소셜 미디어 감성 추적      │    │  - 다중 지표 자동매매 엔진       │   │
│  │  - 매크로 지표 모니터링       │    │  - CVaR 꼬리위험 제어           │   │
...
│  │  + 6 Technical Indicators → Composite Signal [-1, +1]              │ │
│  └──────────────────────────────┬─────────────────────────────────────┘ │
│                                 │                                       │
│                                 ▼                                       │
...
├── 시그널 합성 (Signal)      → 14-Component MI + 6 Technical Indicators
...
| 트레이딩 모듈 | 7개 | swing_strategy, swing_indicators, paper_broker, state_cache 등 |
